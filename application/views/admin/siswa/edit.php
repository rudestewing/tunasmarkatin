   ...
   <section class="content">
      <div class="row">
        ...
        <h2 class="form-signin-heading"><?php echo $header ?></h2>
         ...
         <?php echo form_open_multipart('admin/siswa/tambah', ''); ?>
              <div class="box-body">
                <?php $this->session->flashdata('error'); ?>
                    <div class="form-group">
                  <label for="nama">Nama Lengkap</label>
                  <input  type="text" name="nama" class="form-control" id="nama" disabled="" placeholder="<?php echo $siswa['nama_siswa'];?>" >
                </div>
                <div class="form-group">
            ...
            <option class="form-control"  value="Alumni">Alumni  </option>
