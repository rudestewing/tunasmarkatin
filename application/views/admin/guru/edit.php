	 ...
	 <section class="content">
      <div class="row">
        ...
        <h2 class="form-signin-heading"><?php echo $header ?></h2>
         ...
         <?php echo form_open_multipart('admin/guru/edit/'. $guru['id_guru'] ); ?>
              <div class="box-body">
                <?php $this->session->flashdata('error'); ?>
              	    <div class="form-group">
                  <label for="nama">Nama Lengkap</label>
                  <input  type="text" name="nama" class="form-control" id="nama" placeholder="<?php echo ucfirst($guru['nama_guru']); ?>" disabled="">
                </div>
                <div class="form-group">
          ...
          <div class="form-group">
              ...
              <div class="box-footer">
                <button for="edit"  type="submit" name="edit" value="edit" class="btn btn-primary">Update</button>
              </div>
              <?php form_close(); ?>
            </form>
          </div>
